      ...
      >
        <div className="sheet-hd">
          <div className="sh-title">
            Quests<span className="sh-meta">{quests.length} active</span>
          </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between" style={{ marginBottom: 4 }}>
                  <span
                    style={{
                      fontFamily: 'var(--font-head, Cinzel), serif',
                      fontWeight: 700,
                ...
                <p style={{ color: '#5a4a3a', fontSize: '.78rem', marginBottom: 8 }}>
                  {q.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  {q.reward?.gold > 0 && (
                    <span
                      ...
                      style={rewardStyle('#1a1408', '#d4af70', '#3a2808')}
                    >
                      +{q.reward.gold}g
                    </span>
                  )}
                  {q.reward?.reputationTokens > 0 && (
                    <span
                      className="quest-reward"
                      style={rewardStyle('#0e1408', '#9ec070', '#28380e')}
                    >
                      🪙 {q.reward.reputationTokens}
                    </span>
                  )}
                  {q.reward?.skill && (
                    <span
                      className="quest-reward"
                      style={rewardStyle('#140e1a', '#c8a0ff', '#33285a')}
                    >
                      ✦ Skill
                    </span>
                  )}
                  {q.reward?.consumables &&
                    Object.entries(q.reward.consumables).map(([id, qty]) => (
                      <span
                        key={id}
                        className="quest-reward"
                        style={rewardStyle('#0e1814', '#70c0a0', '#0e3828')}
                      >
                  ...
                  {q.reward?.aura > 0 && (
                    <span
                      className="quest-reward"
                      style={rewardStyle('#1a1228', '#c084fc', '#3a1858')}
                    >
                      +{q.reward.aura} Aura
                    </span>
                  )}
                  {q.reward?.concentration > 0 && (
                    <span
                      className="quest-reward"
                      style={rewardStyle('#0e1a1a', '#60c0c0', '#0e3838')}
                    >
                      +{q.reward.concentration} Conc.
                    </span>
                  )}
                </div>
              </div>
