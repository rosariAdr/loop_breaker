...
describe('Q04 — quêtes d\'exploration (visit)', () => {
  ...
  it('complétée quand le spot ciblé a été visité', () => {
    QUESTS.__visit_test = { id: '__visit_test', name: 'Explore', objectives: [{ id: 'v', type: 'visit', spotId: 'thornmarsh', label: 'Visit the Thornmarsh' }], reward: {} }
...
describe('Q05 — quêtes de craft', () => {
  ...
  it('complétée quand assez de crafts effectués', () => {
    QUESTS.__craft_test = { id: '__craft_test', name: 'Artisan', objectives: [{ id: 'c', type: 'craft', count: 2, label: 'Craft 2 items' }], reward: {} }
