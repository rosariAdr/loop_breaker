...
| **v1.44 (nouveau 2026-07-19)** | **⚔ COMBAT-ATB — Sablier de Guerre + Frappes du Destin (7)** | ex-B06 sorti de v2 (directions ATB timeline visible + QTE actées) ; **PROTO-INT01 d'abord** (décision 2026-07-19) ; CMB-QTE01 ⟶ CRAFTMG-ENGINE01 (v1.42) |
...
- [ ] **PROTO-INT01 — Prototype jetable « Intentions & Ripostes » + aperçu timeline** · S · P3 · 🟢 — ✅ **DÉCIDÉ (2026-07-19) : À FAIRE AVANT le reste de l'épique.** Maquette interactive HORS codebase (artifact HTML) : 1 combat factice avec intents chiffrés au-dessus des ennemis + bandeau timeline ATB cliquable, pour projection avant de trancher CMB-INT01. Aucun code de jeu. AC : Adrian tranche « intents oui/non » sur du visible.
...
- [ ] **CMB-INT01 — Intents chiffrés** · S · P3 · 🟡 — l'ennemi affiche son prochain coup avec les nombres (« ⚔ 12 », buff, gros sort dans 2 tours) au-dessus de sa carte + dans la timeline ; l'IA décide un tour en avance (déplacement d'appel, pas réécriture — l'auto l'ignore). **⛔ gate : décision post-PROTO-INT01.** AC : chaque ennemi télégraphie ; les patterns viennent de la data monstres (2-3 comportements par monstre). ⟶ PROTO-INT01, CMB-ATB02, monsters.js.
